...
The work will begin immediatelly. If were not detected ffmpeg on the bin folder, the script will download automatically for the first time you launch the script.